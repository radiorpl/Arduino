...
void setup() {
 ...
 void loop() {
  ...
  static byte playing = -1;
    ...
    if (playing != 1) {
      playing = 1;
      musicPlayer.playFullFile("DRONE1.WAV");
    ...
    if (lastRange != 2) {
     ...
     if (playing != 2) {
      playing = 2;
      musicPlayer.playFullFile("DRONE2.WAV");
    ...
    if (lastRange != 3) {
     ...
     if (playing != 3) {
      playing = 3;
      musicPlayer.playFullFile("DRONE3.WAV");
    ...
    if (lastRange != 4) {
     ...
     if (playing != 4) {
      playing = 4;
      musicPlayer.playFullFile("DRONE4.WAV");
    ...
    if (lastRange != 5) {
     ...
     if (playing != 5) {
      playing = 5;
      musicPlayer.playFullFile("DRONE5.WAV");
