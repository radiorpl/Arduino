...
/*************************************************** 
  Modified to minic waveshield_pot_9 7/23/13 rpl
...
void setup() {
  Serial.begin(9600);
  Serial.println("Adafruit VS1053 model A looper v1");
 ...
 void loop() {
  ...
  static byte playing = -1;
    ...
    if (playing != 1) {
      playing = 1;
      musicPlayer.playFullFile("DRONE1.mp3");
      Serial.println("DRONE1.mp3");
    }
    ...
    if (lastRange != 2) {
     ...
     if (playing != 2) {
      playing = 2;
      musicPlayer.playFullFile("DRONE2.mp3");
            Serial.println("DRONE2.mp3");
      }
      //lastRange = 2;
    ...
    if (lastRange != 3) {
     ...
     if (playing != 3) {
      playing = 3;
      musicPlayer.playFullFile("DRONE3.mp3");
            Serial.println("DRONE3.mp3");
}
      //lastRange = 3;
    ...
    if (lastRange != 4) {
     ...
     if (playing != 4) {
      playing = 4;
      musicPlayer.playFullFile("DRONE4.mp3");
            Serial.println("DRONE4.mp3");
}
      //lastRange = 4;
    ...
    if (lastRange != 5) {
     ...
     if (playing != 5) {
      playing = 5;
      musicPlayer.playFullFile("DRONE5.mp3");
            Serial.println("DRONE5.mp3");
}
      //lastRange = 5;
