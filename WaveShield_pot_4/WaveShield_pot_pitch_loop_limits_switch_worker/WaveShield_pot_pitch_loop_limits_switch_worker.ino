...
//8-20-13 attempt to make a switch activate the speed control without stopping the song
#include <FatReader.h>
#include <SdReader.h>
...
//change to speed control to if else 8-30-13
void loop() {
...
//re enabled sensorValue, tried moving all this stuff outside the loop 8-30-13  
//with playback speed changer from above
    ...
    byte i;
        ...
        Serial.println("normal speed");
         ...
         else ( ((potval - lastpotval) > HYSTERESIS) || ((lastpotval - potval) > HYSTERESIS)) {
