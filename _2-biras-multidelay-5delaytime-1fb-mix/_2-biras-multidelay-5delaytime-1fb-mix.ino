...
AudioMixer4              mixer4;         //xy=296,556
AudioMixer4              mixer2;         //xy=359,178
AudioEffectDelay         delay1;         //xy=420,351
AudioMixer4              mixer3;         //xy=619,234
AudioMixer4              mixer5;         //xy=624,355
AudioOutputI2S           i2s1;           //xy=756,288
...
AudioConnection          patchCord7(mixer4, 0, mixer5, 0);
AudioConnection          patchCord8(mixer4, 0, mixer2, 2);
...
AudioConnection          patchCord18(mixer5, 0, i2s1, 1);
