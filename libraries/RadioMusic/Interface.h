...
#include "AnalogInput.h"
	...
	#define CHAN_POT_PIN A10 	// pin for Channel pot -
#define CHAN_CV_PIN A6 		// pin for Channel CV ok
#define TIME_POT_PIN A7 	// pin for Time pot ok
#define TIME_CV_PIN A11		// pin for Time CV -
#define RESET_BUTTON 8 		// Reset button ok 
#define RESET_CV 33 		// Reset pulse input -
