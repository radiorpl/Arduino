...
Atm_encoder& Atm_encoder::begin( int pin1, int pin2, int divider /* = 1 */ ) {
  ...
  const static state_t state_table[] PROGMEM = {
    /*          	ON_ENTER   ON_LOOP  	ON_EXIT  EVT_TIMER 		EVT_UP  	  EVT_DOWN  		ELSE */
    /* IDLE  */       	-1,    LP_IDLE,    -1,     		-1,		WAIT_UP_1_DB, 	WAIT_DOWN_1_DB,   	-1,
	/* WAIT_UP_1_DB */  -1,  	WAIT_UP_1_DB, -1,    WAIT_UP_1,		-1,  			-1,  			-1,
	/* WAIT_UP_1 */     -1,  WAIT_UP_1,  	-1,    	    -1,		WAIT_UP_2_DB, 	WAIT_DOWN_1_DB,  	-1,
	/* WAIT_UP_2_DB */  -1,  	WAIT_UP_2_DB,    		-1,    	WAIT_UP_2,			-1,  			-1,  			-1,
	/* WAIT_UP_2 */     -1,  WAIT_UP_2,  	-1,    		-1,		WAIT_UP_3_DB,  	WAIT_DOWN_1_DB,  	-1,
	/* WAIT_UP_3_DB */  -1,  	WAIT_UP_3_DB,    		-1,    	WAIT_UP_3,			-1,  			-1,  			-1,
	/* WAIT_UP_3 */     -1,  WAIT_UP_2,  	-1,    		-1,		WAIT_UP_4_DB,  	WAIT_DOWN_1_DB,  	-1,
	/* WAIT_UP_4_DB */  -1,  	WAIT_UP_4_DB,    		-1,    	WAIT_UP_4,			-1,  			-1,  			-1,  
	/* WAIT_UP_4 */     -1,   WAIT_UP_4, 	-1,   		-1,		WAIT_UP_DB,        WAIT_DOWN_1,   	-1,
	/* WAIT_UP_DB */  	-1,  	 WAIT_UP_DB,    		-1,    		UP,				-1,  			-1,  			-1,
	/* WAIT_DOWN_1_DB */ -1,  	-1,    		-1,    	WAIT_DOWN_1,	-1,  			-1,  			-1,
	/* WAIT_DOWN_1 */    -1,  WAIT_DOWN_1, 	-1,    		-1,		WAIT_UP_1_DB, 	WAIT_DOWN_2_DB,  	-1,
	/* WAIT_DOWN_2_DB */ -1,  	-1,    		-1,    	WAIT_DOWN_2,	-1,  			-1,  			-1,
	/* WAIT_DOWN_2 */    -1,  WAIT_DOWN_2,	-1,    		-1,		WAIT_UP_1_DB,  	WAIT_DOWN_3_DB,  	-1,
	/* WAIT_DOWN_3_DB */ -1,  	-1,    		-1,    	WAIT_DOWN_3,	-1,  			-1,  			-1,
	/* WAIT_DOWN_3 */    -1,  WAIT_DOWN_2,   -1,    	-1,		WAIT_UP_1_DB,    WAIT_DOWN_4_DB,  	-1,
	/* WAIT_DOWN_4_DB */ -1,  	-1,    		-1,    	WAIT_DOWN_4,	-1,  			-1,  			-1,  
	/* WAIT_DOWN_4 */    -1,   WAIT_DOWN_4, -1,   		-1,		WAIT_UP_1_DB,     WAIT_DOWN_DB,   	-1,
	/* WAIT_DOWN__DB */  -1,  	  -1,    	-1,    	 	DOWN,		-1,  			-1,  			-1,
    /* UP    */     	ENT_UP,   -1,      -1,     		-1,			-1,      		-1, 			IDLE,
    /* DOWN  */   		ENT_DOWN, -1,      -1,     		-1,			-1,      		-1, 			IDLE,
  };
  // clang-format on
...
Atm_encoder& Atm_encoder::trace( Stream& stream ) {
  Machine::setTrace( &stream, atm_serial_debug::trace, "ENCODER\0EVT_TIMER\0EVT_UP\0EVT_DOWN\0ELSE\0IDLE\0WAIT_UP_1_DB\0WAIT_UP_1\0WAIT_UP_2_DB\0WAIT_UP_2\0WAIT_UP_3_DB\0WAIT_UP_3\0WAIT_UP_4_DB\0WAIT_UP_4\0WAIT_UP_DB\0WAIT_DOWN_1_DB\0WAIT_DOWN_1\0WAIT_DOWN_2_DB\0WAIT_DOWN_2\0WAIT_DOWN_3_DB\0WAIT_DOWN_3\0WAIT_DOWN_4_DB\0WAIT_DOWN_4\0WAIT_DOWN_DB\0UP\0DOWN" );
  return *this;
}
